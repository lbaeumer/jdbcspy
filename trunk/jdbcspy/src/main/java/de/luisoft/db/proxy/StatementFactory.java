...
import de.luisoft.db.proxy.handler.PreparedStatementHandler;
import de.luisoft.db.proxy.handler.StatementHandler;
 ...
 * <p>Company: </p>
 * @author Lui Baeumer
 * @version $Id: StatementFactory.java 917 2007-10-25 18:02:24Z lui $
 */
public class StatementFactory {
     ...
     */
    public Statement getStatement(ClientProperties props,
                                         Statement ps,
        ...
        if (ps instanceof CallableStatement) {
            return factory.getCallableStatementProxy(props,
                (CallableStatement) ps, metaData, sql, listener, failedListener, method);
        }
        else if (ps instanceof PreparedStatement) {
            return factory.getPreparedStatementProxy(props,
                (PreparedStatement) ps, metaData, sql, listener, failedListener, method);
        }
        else {
     ...
     */
    private Statement getStatementProxy(ClientProperties props,
                                        Statement ps,
                                        ProxyConnectionMetaData metaData,
                                        String sql,
                                        List listener,
        ...
        Statement proxyPrep = (Statement) Proxy.newProxyInstance(
            Checkable.class.getClassLoader(),
            new Class[] {Statement.class, Checkable.class,
                    StatementStatistics.class },
            handler);
    ...
    private PreparedStatement getPreparedStatementProxy(
        ...
        PreparedStatement proxyPrep = (PreparedStatement) Proxy.newProxyInstance(
            Checkable.class.getClassLoader(),
            new Class[] {PreparedStatement.class, Checkable.class,
                    StatementStatistics.class },
            handler);
     ...
     * @return the proxy statement
     */
    private CallableStatement getCallableStatementProxy(
        ClientProperties props, CallableStatement ps,
        ProxyConnectionMetaData metaData,
        String sql,
        List listener,
        List failedListener,
        ...
        CallableStatement proxyPrep = (CallableStatement) Proxy.newProxyInstance(
            Checkable.class.getClassLoader(),
            new Class[] {CallableStatement.class, Checkable.class,
                    StatementStatistics.class },
            handler);
